    ...
    <div className="grid min-h-screen lg:grid-cols-2 bg-slate-50">
      <div className="relative hidden overflow-hidden lg:block">
        <img 
          ...
          alt="Premium Real Estate Skyscraper" 
          className="absolute inset-0 h-full w-full object-cover" 
        />
        <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/20 to-black/5" />
        <div className="absolute top-6 left-6 z-10">
          <Link to="/" className="flex items-center gap-3">
            ...
            />
            <div className="hidden h-11 w-11 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/25">
              <span className="text-white font-bold text-sm">RE</span>
            </div>
            <div className="flex flex-col">
              <span className="text-lg font-bold text-white drop-shadow-md">RealEstate</span>
              <span className="text-[10px] text-emerald-400 font-medium drop-shadow-md">Due Diligence</span>
            </div>
          </Link>
        </div>
        <div className="absolute bottom-8 left-8 right-8 z-10 text-white">
          <div className="space-y-6">
            ...
            <div className="text-sm text-white/90 drop-shadow-md">Marcus Levine — Managing Director, Blackstone RE</div>
            <div className="flex gap-6 pt-4 text-[11px] uppercase tracking-wider text-white/80 drop-shadow-md">
...
export function GoogleButton({ children = "Continue with Google" }) {
  ...
  return (
    <button 
      ...
      className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-[14px] font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition-colors"
    >
