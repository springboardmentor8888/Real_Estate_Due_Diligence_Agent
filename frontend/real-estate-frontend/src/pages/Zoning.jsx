...
function Zoning() {
  ...
  useEffect(() => {
    // Realistic zoning compliance mock dataset based on numericId
    setZoning({
      zoneType: "C-4 Commercial IT/ITES High-Density District",
      zoneCode: `C-${(parseInt(numericId) % 4) + 1}`,
      allowedUsage: "IT/ITES Tech Parks, Corporate Headquarters, Financial Services, Retail Showrooms",
      currentUsage: "Multi-Tenant Grade-A Commercial IT Park (12 Storeys, 450,000 sq ft)",
      municipalRules: {
        maxFar: "3.50 FAR",
        currentFar: "2.85 FAR",
        maxHeight: "Maximum 18 Floors / 65 Meters",
        frontSetback: "12.0 Meters Required",
        sideSetback: "8.5 Meters Required",
        parkingRatio: "1 Car Space per 500 sq ft Built-Up Area",
        authority: "HMDA Urban Development Planning Authority",
      },
      violations: "Nil Violations Certified. 100% compliant with Master Plan 2031 regulations.",
    });
  }, [numericId]);
